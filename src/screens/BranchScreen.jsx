  ...
  return (
    <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
      ...
      <View style={s.mapPlaceholder}>
        ...
        <Text style={s.mapText}>ORLANDO EAST BRANCH</Text>
        <Text style={s.mapSub}>Ward 62 · Soweto Region · Gauteng</Text>
      </View>

      <Text style={s.sectionTitle}>Branch Executive Committee</Text>
      <List icon="♟" title="Branch Secretary" sub="Nomsa Dlamini (082 112 4490)" />
      <List icon="👤" title="Branch Chairperson" sub="Sibusiso Thwala" />
      <List icon="☎" title="Branch Office Contact" sub="011 935 2200" />
      <List icon="📍" title="Branch Meeting Venue" sub="Orlando East Community Hall" />
...
const s = StyleSheet.create({
  ...
  mapIcon: { fontSize: 32, color: Colors.primary },
  mapText: { color: Colors.primary, fontSize: 14, fontWeight: '900', letterSpacing: 1, marginTop: 4 },

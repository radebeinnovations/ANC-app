...
export default function AdminDashboard() {
  ...
  if (!scope || accessError) return <View style={s.authPage}><View style={s.authCard}><Text style={s.brand}>ANC UNITY</Text><Text style={s.authTitle}>Dashboard access required</Text><Text style={s.authCopy}>{accessError || 'This account does not have a dashboard role.'}</Text><TouchableOpacity style={s.primaryButton} onPress={load}><Text style={s.primaryButtonText}>Try again</Text></TouchableOpacity><TouchableOpacity onPress={signOut}><Text style={s.signOut}>Sign out</Text></TouchableOpacity></View></View>;
